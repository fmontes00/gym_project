...
from . import views
from .views import HomeView, ExerciseFormView, EquipmentFormView, RoutineFormView, RoutineBlockFormView
...
urlpatterns = [
    ...
    path("create_routine_block", RoutineBlockFormView.as_view(), name="create_routine_block"),
]
